...
{
    [TestFixture]
    public class WhenRepositoryIsNotEmpty : WhenRepositoryIsEmpty
    {
        [SetUp]
        ...
        {
            var status = WorkingTree.GetStatus().GetStatusOf("a.txt");
        ...
        public void WorkingTreeGetStatusOf_WhenFileIsTrackedAndModifiedAndAccessedByFullPath_ReturnsModified()
        {
            ...
            var status = WorkingTree.GetStatus().GetStatusOf(Path.Combine(Git.WorkingDirectory, "a.txt"));
        ...
        public void WorkingTreeGetStatusOf_WhenFileIsNotTracked_ReturnsUntracked()
        {
            ...
            var status = WorkingTree.GetStatus().GetStatusOf("untracked.txt");
        ...
        public void WorkingTreeGetStatusOf_WhenFileIsIgnored_ReturnsIgnored()
        {
            ...
            var status = WorkingTree.GetStatus().GetStatusOf("ignored.txt");
