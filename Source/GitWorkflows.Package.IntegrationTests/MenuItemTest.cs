...
namespace GitWorkflows.Package.IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Constants.guidPackageCmdSet, (int)Constants.cmdidCommit);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "GitWorkflows", "BojanResnik.GitWorkflows_Package.GitWorkflowsPackage");
